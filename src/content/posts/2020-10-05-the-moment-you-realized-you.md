...
With the digitalization of the typography, through the birth of the internet, today there are uncountable arts of typography which are in a constant increasing number.
...
***Typography Importance from a business perspective:***

The designer’s role while designing is to emulate the tone of the word or sentence while choosing typographic. You need to take time to relate both, what it reads and what you want it to say, because moods, emotions and even the atmosphere can be set by the choice of the text.

Typography is the stamp of personality we put in our projects, it is the art of putting together in a friendly way a legible and clear writing for the delight of our readers or customers.

A good designer takes in consideration a strong hierarchy and good contrast to set the tone that would determinate the success of feature of the product on your website or application. Balance is the key word in this.

If you want to build trust inside your readers, you have to understand that they will attach the type of fonts you will use in your website or application with the type of business you want to present to them.

Therefore, make sure that your typography reinforces the message of the text. Do not used more than three fonts in your projects and keep decorative fonts as minimum as possible in order to keep consistency typefaces and to avoid a disorganized and chaotic interface.
...
***The consequences of bad designs, in real life.***

Before I finish this topic, I would like to demonstrate a couple of real-life examples of bad typography, designed by “designers” ignoring all recommendations mentioned about, which brings miscommunication, confusion and ambiguity. Please judge for yourself and make your own conclusions.

By default, human mint is sort of dirty, the following example does not help to mitigate it this issue at all.
...
Due to the bad word spacing in this sign, it brings confusion to the reader at a first glance.

The intent message in the following sing is not the exception in terms of misinterpertation. It should read read “Massage Therapist” but instead it reads…
...
A single misplace space between the second E and the R surely will reduce considerable the number of new customers this “therapist” will have in that office.

In conclusion, the moment you realized you have done a bad design or choose the incorrect typography, is the moment you realized you can improve it by following the correct guidelines.
