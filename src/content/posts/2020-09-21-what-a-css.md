...
description: The correct implementation of fonts in your projects can determine
  the success or failure of it. For that reason, it is important to determine
  the correct deployment of your selected fonts and the speed with which they
  load in browsers. Here is a bit of history and some tricks that will help you
  with the font optimization on your next CSS project.
---
<!--\[if gte mso 9]><xml>
