...
An exlent practice a good developer should follow is what is call "Graceful degradations Vs Progressive Enhancement" which are responsive strategies that a developer can take when developing for different browsers and its different versions.
